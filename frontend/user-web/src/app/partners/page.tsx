...
const partners = [
    ...
    { name: '去哪儿旅?', category: 'OTA平台', logo: '✈️' },
      ...
      <main className="pt-16 pb-28 lg:pb-10">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-500 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <p className="text-white/90 text-lg max-w-2xl">
              携手优质合作伙伴，为用户提供更丰富的旅游资源和更优质的服务体?
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { icon: Globe, title: '资源共享', desc: '整合双方优势资源，实现互利共? },
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-3xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { title: '内容合作', desc: '优质旅游内容入驻平台，共同打造丰富的内容生? },
                { title: '渠道合作', desc: '分销合作，共享用户资源，实现双赢' },
                { title: '品牌联合', desc: '联合营销活动，共同推广品? },
              ].map((item) => (
          ...
          <div className="mt-12 text-center">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">成为我们的合作伙</h2>
            <p className="text-slate-500 mb-6">期待与您携手共创旅游新体</p>
