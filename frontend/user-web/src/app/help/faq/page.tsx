...
const faqs = [
  ...
  { q: '忘记密码怎么办？', a: '在登录页面点?忘记密码"，输入注册手机号，通过验证码重置密码? },
    { q: '如何使用AI行程规划?', a: '登录后进?AI助手"页面，描述您的旅行需求（目的地、时间、人数等），AI将自动为您生成专属行程规划? },
  { q: '行程规划可以修改吗？', a: '当然可以！AI生成的行程只是建议，您可以自由调整每一天的安排，添加或删除景点? },
    { q: '如何联系客服?', a: '您可以通过以下方式联系我们?. 拨打客服热线 400-888-9999?. 点击页面右下角在线客服；3. 发送邮件至 service@travelai.com' },
  { q: '会员等级有哪些？', a: '会员分为10个等级（LV1-LV10），从普通会员到至尊VIP。等级越高，享受的权益越多，包括专属折扣、优先客服、免费增值服务等? },
  { q: '订单如何取消和退款？', a: '?我的订单"中找到对应订单，点击"取消"即可。退款将?-7个工作日内原路返回支付账户。特殊商品退款规则可能不同? },
